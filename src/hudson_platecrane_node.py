...
class PlateCraneNode(RestNode):
    ...
    def create_resources(self):
        ...
        try:
            ...
            self.logger.log_info(
                f"The PlateCrane EX gripper resource already exists: {self.gripper_resource.resource_id}"
            )
        except Exception:
            self.logger.log_info(
    ...
    def replace_lid(
        ...
        if lid_resource and lid_slot_resource:
            ...
            return ActionFailed(
                f"lid_resource or lid_slot_resourse do not exist. {lid_resource=}, {lid_slot_resource=}"
            )
